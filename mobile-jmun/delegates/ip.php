			...
			<div class="fs-form-wrap" id="fs-form-wrap">
				<div class="fs-title">
					...
					<div class="codrops-top">
						<a class="codrops-icon codrops-icon-prev" href="../index.html"><span>Back</span></a>
						</div>
				</div>
				<form id="myform" class="fs-form fs-form-full" method="post" action=" ">
					<ol class="fs-fields">
						...
						<li>
							<label class="fs-field-label fs-anim-upper" for="new">Which post would you like to apply for?<br><span style="font-size:18px;">Editor / Journalist / Photographer / Caricaturist</span><br><span  style="font-size:15px;">If applying for the post of PHOTOGRAPHER, send us 5 pictures from your work to <span style="color:yellow;">jpmun2015@gmail.com</span></span></label>
							<textarea class="fs-anim-lower" id="new" name="new" placeholder="Mention here"></textarea>
						
						</li>
						<li>
							<label class="fs-field-label fs-anim-upper" for="qu8">MUN Experience as International Press</label>
							<textarea class="fs-anim-lower" id="qu8" name="qu8" placeholder="Describe here"></textarea>
						
						</li>
                        <li>
							<label class="fs-field-label fs-anim-upper" for="qu9">Other Related Experiences </label>
							<textarea class="fs-anim-lower" id="qu9" name="qu9" placeholder="Describe here"></textarea>
						
						</li>
						
						<li>
							<label class="fs-field-label fs-anim-upper" style="font-size:20px;" for="qu10">For Reporters:
